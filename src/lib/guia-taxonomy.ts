...
const subs = (labels: string[]): Subcategory[] => labels.map((l, i) => sub(l, { order: i + 1 }));
...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    subcategories: subs(["Motoboy", "Transportadoras", "Entregas", "Fretes", "Mudanças"]),
  },
  {
    slug: "comercio",
    label: "Compras",
  ...
  },
  {
    ...
    subcategories: subs(["Igrejas", "ONGs", "Associações", "Clubes", "Centros Comunitários"]),
  },
  {
    slug: "lazer-turismo",
    label: "Lazer e Turismo",
    emoji: "🎭",
    icon: Palmtree,
    from: "#0d7a5f",
    to: "#5cbdb9",
