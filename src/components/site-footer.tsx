      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-6 px-4 py-8 text-sm text-muted-foreground">
        <div className="grid gap-6 sm:grid-cols-3">
          <div>
            ...
            <p className="text-xs">
              O guia oficial do bairro: comércio, vagas, imóveis e comunidade.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-1.5 text-xs">
              <li>
                <a
                  href={`https://wa.me/55${SITE_CONTACT.phoneDigits}`}
                  target="_blank"
                  rel="noreferrer"
              ...
              <li>
                <a
                  href={`https://instagram.com/${SITE_CONTACT.instagram.replace("@", "")}`}
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-2 hover:text-foreground"
                >
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-xs">
              ...
              <li>
                <Link to="/anuncie" className="hover:text-foreground">
                  Anuncie
                </Link>
              </li>
              <li>
